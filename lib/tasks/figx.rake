...
namespace :figx do
  task seed: :environment do
    ...
    FactoryBot.create_for_repository(:collection, id: "597edce8-3a2f-41cd-be2b-182dae7b9a8f", title: "Test Collection", description: "Test Description", slug: "studentperf")
