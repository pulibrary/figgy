  ...
  private
    ...
    def document_coin_hash
      {
        ...
        coin_references_s: decorator.references,
        coin_references_sort: decorator.references&.first,
        coin_citations_s: decorator.citations,
        coin_citations_sort: decorator.citations&.first,
    ...
    def document_parent_hash
      return unless parent
      {
        ...
        issue_citations_s: parent.citations,
        issue_citations_sort: parent.citations&.first,
        issue_references_s: parent.references,
        issue_references_sort: parent.references&.first,
