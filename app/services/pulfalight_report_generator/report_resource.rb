class PulfalightReportGenerator::ReportResource
  ...
  def self.resource_fields
    [
      ...
      Sequel[:metadata].pg_jsonb["is_portion"][0].as(:is_portion),
  ...
  # The ArchivesSpace component id, used to key the report (e.g. "AC140_c0329")
  def component_id
