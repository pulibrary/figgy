  ...
  class CoverPageGenerator
    ...
    def apply(prawn_document)
      ...
      prawn_document.bounding_box([15, Canvas::LETTER_HEIGHT - 15], width: Canvas::LETTER_WIDTH - 30, height: Canvas::LETTER_HEIGHT - 30) do
        ...
        prawn_document.text "Available Online at: <u><a href='#{helper.solr_document_url(id: resource.id.to_s)}'>#{helper.solr_document_url(id: resource.id.to_s)}</a></u>", inline_format: true
      end
    end
