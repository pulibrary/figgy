...
class Wayfinder < BaseWayfinder
  ...
  self.registered_wayfinders = {
    ...
    NumismaticFirm => NumismaticFirmWayfinder,
    NumismaticLoan => NumismaticLoanWayfinder,
    NumismaticIssue => NumismaticIssueWayfinder,
    NumismaticMonogram => NumismaticMonogramWayfinder,
    NumismaticPerson => NumismaticPersonWayfinder,
    NumismaticPlace => NumismaticPlaceWayfinder,
    NumismaticProvenance => NumismaticProvenanceWayfinder,
