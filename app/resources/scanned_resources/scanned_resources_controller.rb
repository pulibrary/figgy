...
class ScannedResourcesController < BaseResourceController
  ...
  private
    ...
    # TODO: if this differs based on the change set should we just put it in the
    # change set?
    def ingest_folder
    ...
    def change_set_class
      ChangeSet.class_from_param(change_set_param) if change_set_param ||
      find_resource(params[:id]).change_set ||
      nil
    end
end
