...
module Figgy
  ...
  def background_pdf_generating?
    config["background_pdf_generating"]
  end
  ...
  private
    ...
    module_function :global_protect_ips, :all_environment_config, :index_read_only?, :pulfalight_unpublished_token, :background_pdf_generating?
end
