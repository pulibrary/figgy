...
server "figgy-web-staging1.princeton.edu", user: "deploy", roles: %w[app db web worker]
server "figgy-web-staging2.princeton.edu", user: "deploy", roles: %w[app web worker worker_db]
