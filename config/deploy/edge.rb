...
server "figgy-edge-web1.lib.princeton.edu", user: "deploy", roles: %w[app db production_db web]
server "figgy-edge-worker1.lib.princeton.edu", user: "deploy", roles: %w[worker]
