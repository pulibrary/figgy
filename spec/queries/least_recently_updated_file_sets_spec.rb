...
RSpec.describe LeastRecentlyUpdatedFileSets do
  ...
  describe "#least_recently_updated_file_sets" do
    it "finds least recently updated file sets with the given limit" do
      result = query_service.custom_queries.least_recently_updated_file_sets
