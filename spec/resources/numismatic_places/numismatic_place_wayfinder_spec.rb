...
describe NumismaticPlaceWayfinder do
  ...
  let(:numismatic_place) do
    res1 = NumismaticPlace.new(title: "Polis1")
    res2 = NumismaticPlace.new(title: "Polis2")
    ch1 = NumismaticPlaceChangeSet.new(res1)
    ch2 = NumismaticPlaceChangeSet.new(res2)
