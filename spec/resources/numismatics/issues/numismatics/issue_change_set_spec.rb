...
RSpec.describe Numismatics::IssueChangeSet do
  ...
  describe "#primary_terms" do
    it "includes displayed fields" do
      ...
      expect(change_set.primary_terms.keys).to eq(["", "Monograms", "Places", "Obverse", "Obverse Attributes", "Reverse", "Reverse Attributes", "Artist", "Citation", "Note", "Subject", "Rights and Notes"])
