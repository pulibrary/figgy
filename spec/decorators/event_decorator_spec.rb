...
RSpec.describe EventDecorator do
  ...
  let(:resource) { FactoryBot.create_for_repository(:cloud_fixity_event, resource_id: preservation_object.id, child_id: file_metadata.id, child_property: :metadata_node, current: true) }
