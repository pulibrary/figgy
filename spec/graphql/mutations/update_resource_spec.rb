...
RSpec.describe Mutations::UpdateResource do
  describe "schema" do
    ...
    it { is_expected.to accept_arguments(id: "ID!", viewingHint: "String", label: "String", memberIds: "[String!]", startPage: "String", viewingDirection: "Types::ViewingDirectionEnum") }
  end
  ...
  context "when given permission" do
    ...
    context "when given good data" do
      it "updates the record" do
        ...
        resource = FactoryBot.create_for_repository(:scanned_resource, viewing_hint: "paged", title: "label", files: [file1], viewing_direction: "left-to-right")
