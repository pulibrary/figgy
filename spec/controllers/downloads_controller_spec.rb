...
RSpec.describe DownloadsController do
  ...
  describe "GET /downloads/:obj/file/:id" do
    ...
    context "with a public complete HLS playlist part and no auth token" do
      ...
      it "allows download", run_real_derivatives: true, run_real_characterization: true do
        ...
        stub_ezid(shoulder: "99999/fk4", blade: "123456")
        parent = FactoryBot.create_for_repository(:complete_recording, files: [file], visibility: Hydra::AccessControls::AccessRight::VISIBILITY_TEXT_VALUE_PUBLIC)
