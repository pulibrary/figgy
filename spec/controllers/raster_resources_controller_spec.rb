...
RSpec.describe RasterResourcesController do
  ...
  describe "GET /raster_resources/:id/geoblacklight" do
    ...
    let(:builder) { instance_double(GeoResources::GeoDiscovery::DocumentBuilder) }

    before do
      allow(GeoResources::GeoDiscovery::DocumentBuilder).to receive(:new).and_return(builder)
    end
