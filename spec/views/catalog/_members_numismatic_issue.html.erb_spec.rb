...
RSpec.describe "catalog/_members_numismatic_issue" do
  context "when the NumismaticIssue has Coin members" do
    ...
    it "shows them" do
      ...
      expect(rendered).to have_link "Edit", href: edit_coin_path(child.id)
    end
  end
end
