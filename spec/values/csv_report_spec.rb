...
RSpec.describe CSVReport do
  describe "#write" do
    it "converts an array of resources to a CSV and writes it to a path" do
      ...
      report = described_class.new(resources.lazy, fields: [:title, :source_metadata_identifier, :identifier, :visibility, :state, :call_number])
      ...
      expect(report.headers).to eq ["Title", "Source metadata identifier", "Identifier", "Visibility", "State", "Call number"]
