  ...
  describe "#generate" do
    ...
    context "with an issue and coin that both have reference URIs" do
      ...
      it "generates a nomisma rdf file with all URIs" do
        ...
        values = select_triples(graph, "http://arks.princeton.edu/ark:/88435/testcoin2")
    ...
    context "with a coin that has an Obverse and Reverse coin images" do
      ...
      it "generates a nomisma rdf file with obverse and reverse description objects" do
        ...
        # Description
        values = select_triples(graph, "http://arks.princeton.edu/ark:/88435/testcoin#obverse")
        ...
        # Description
        values = select_triples(graph, "http://arks.princeton.edu/ark:/88435/testcoin#reverse")
